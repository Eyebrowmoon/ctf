...
def mem(addr):
  offset = addr - 0x87e4  
  result = arr[offset] * 0x100 + arr[offset + 1]
...
# 4
s.add(((inputs[3] ^ 0xc5db) + 0x14aa) ^ mem(0x880a) == 0)
s.add((inputs[4] * inputs[15]) ^ mem(0x880c) == 0)
...
for variable in inputs:
  val = model[variable]
  arg = hex(int(str(val)))[2:]

  # print variable
  payload += arg.rjust(4, '0').upper()
